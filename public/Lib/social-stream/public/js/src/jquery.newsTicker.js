        ...
        Plugin.prototype = {
                ...
                moveDown: function() {
                        if (!this.moving) {
                            ...
                            var element = this.$el.children('li').filter(":visible").filter(':last');
                            if (element.length) {
								var thisheight = this.options.row_height;
                                if (element.css("height"))
                                    thisheight = element.css("height");
                                element.detach().prependTo(this.$el).css('marginTop', '-' + thisheight.replace(/[^\d]/g,"") + 'px')
                ...
                moveUp: function() {
                        if (!this.moving) {
                            ...
                            var element = this.$el.children('li').filter(":visible").filter(':first');
                            if (element.length) {
								var thisheight = this.options.row_height;
                                if (element.css("height"))
                                    thisheight = element.css("height");
                                element.animate({marginTop: '-' + thisheight.replace(/[^\d]/g,"") + 'px'}, this.options.speed,
                                        function(){
