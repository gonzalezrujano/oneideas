    ...
    function create_item( $feed_class, $param, $attr = array(), $output = array(), $sbi = 0, $i = 0, $ifeed = 0 ) {
        ...
        if (@$attr['carousel']) {
            ...
            if (@$param['thumb'] && @$output['thumb']) {
                ...
                if (@$param['user']['image']) {
                    $thumb = '<div class="'.$cropclass.'"><img class="sb-img" src="' . $param['user']['image'] . '" alt=""><br /><span>'.$user_title.'</span></div>';
                }
            }
            if (@$thumb)
                $sbthumb .= '
        ...
        if ( $attr['type'] == 'timeline' ) {
            $icon = ( @$param['icon'][1] ) ? '<img class="sb-img" src="'.$param['icon'][1].'" style="vertical-align:middle" alt="">' : '<i class="sb-icon sb-' . $feed_class . '"></i>';
            $out = '
          <div class="timeline-row"'.$idstr.'>
            ...
            $icon = ( @$param['icon'][0] ) ? '<img class="sb-img" src="'.$param['icon'][0].'" style="vertical-align:middle" alt="">' : '<i class="sb-icon sb-' . $feed_class . ' sb-2x pull-left"></i>';
