...
$(document).ready(function () {
  $('[data-icheck]').iCheck({
    ...
    radioClass: 'iradio_flat-red' // increaseArea: '20%' // optional
  ...
  var onWindowResize = function onWindowResize() {
    ...
    $sidebars.css({
      minHeight: calculatedSidebarMinHeight + 'px'
    });
  };
  ...
  $('#trigger-demo-notify').click(function () {
    $('.top-right').notify({
      message: {
        html: 'Great looking notification at the top right of the page!<br><br>These can be configured to display at any corner...'
      },
      type: 'success'
    }).show();
    $('.top-right').notify({
