...
export default class Login extends Component {
    ...
    handleLogin(e){
        ...
        axios.post('/ajax-post-login', {correo, password})
            .then(res => {
        ...
        return (
            ...
            <div id="login-hidden" className="container login-display" >
                <div className="absolute-center">
                    ...
                    <form method="POST" onSubmit={this.handleLogin} className="form-login form">
                        ...
                        <div className="form-group">
                            <input type="password" className="form-control input-lg" id="password" name="password" value={password} onChange={this.handleChange}  placeholder="Ingresa tu contraseña" />
                        </div>
                        ...
                        <ul className="login-bottom-links">
                            <li><a href={urlRecuperar}>¿Olvidaste tu contraseña?</a></li>
                        </ul>
