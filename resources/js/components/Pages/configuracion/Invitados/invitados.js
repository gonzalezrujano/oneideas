...
export default class Usuarios extends Component {
    ...
    componentDidMount() {
        axios
            .post("api/invitaciones/get-info", {
                headers: {
                ...
                <div>
                    ...
                    <div className="content-wrapper">
                        ...
                        <div id="sweet" className="container-fluid">
                            ...
                            <label class="my-1 mr-2 form-control-sm">
                                <strong>Empresa</strong>
                            </label>
                            {this.state.permisoUsuario.nombre ==
                            "ADMINISTRADOR" ? (
                                <select
                                    class="form-control form-control-sm my-1 mr-sm-2 col-2"
                                    id="pro-find-empresa"
                                ...
                                >
                                    ...
                                    "ADMINISTRADOR" ? (
                                        ...
                                        /*</div><option value="{{ $emp->_id }}">{{ $emp->Nombre }}</option>*/
                                        ""
                                    )}
                                </select>
                            ) : (
