...
export default class Edit extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            nombre: "",
            idEtapa: this.props.match.params.id,
            evento: "",
    ...
    componentDidMount() {
        axios
            .get("api/etapas/" + this.state.idEtapa, {
                headers: {
        ...
        axios
            ...
            .then(res => {
                ...
                if (res.data.code === 200) {
                    Swal.fire({
                        text: "Etapa modificada exitosamente",
                        type: "success",
                    ...
                    sweetalert(
                        "Error al modificar la etapa. Consulte al Administrador.",
                        "error",
                        "sweet"
                    );
                }
