...
@section('heading')
    <h1 class="page-header-heading"><i class="fas fa-coffee page-header-heading-icon"></i>Agregar Plato</h1>
@endsection
    ...
    <div class="col-lg-12">
        ...
        <div class="widget widget-default">
            ...
            <div class="widget-body">
                ...
                <form id="form-add-plato" class="form-change-password form" enctype="multipart/form-data">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-datos" role="tabpanel" aria-labelledby="pills-datos-tab">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control form-control-sm" id="etapa" name="etapa">
                                            ...
                                            @foreach($etapas as $etapa)
                                                <option value="{{ $etapa->_id}}">{{ $etapa->Titulo }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control form-control-sm" value="" id="numero_plato" name="numero_plato" placeholder="" />
                                    </div>
                                </div>
                                <div class="form-group row">
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $('button#save_etaoa').click(save_plato)

            function save_plato() {
                var form = $('form#form-add-plato');
                ...
                if (titulo.trim() == '' || numero_plato.trim() == '' || descripcion.trim() == '' || status.trim() == '' || etapa.trim() == '') {
