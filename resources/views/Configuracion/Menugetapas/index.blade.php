...
@section('heading')
    <h1 class="page-header-heading"><i class="fas fa-folder-open page-header-heading-icon"></i>Menu Gastronómico Etapas</h1>
@endsection
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        datatable_agenda.DataTable({
                ...
                "columns":[
                    {"width": "10%", data: 'Numero_etapa', "searchable": true, "bSortable": false},
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row, meta){
                            ...
                            let linkShow   = './menu-etapas-show/' + row._id;
                            let linkEdit   = './menu-etapas-edit/' + row._id;
        ...
        function modalDelete(id){
            ...
            Swal.fire({
                text: "¿Está seguro que desea borrar la etapa del menu?.",
                type: "warning",
