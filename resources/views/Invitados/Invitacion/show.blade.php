...
@section('heading')
    <h1 class="page-header-heading"><i class="fas fa-user-friends page-header-heading-icon"></i>&nbsp;<a href="{{ route('invitados.invitacion') }}">Invitación</a>  / Ver Archivos</h1>
@endsection
            ...
            <div class="widget-body">
                ...
                @else
                    ...
                    <div class="alert alert-danger mb-4" role="alert">
                        <i class="fas fa-info-circle"></i>&nbsp;No existen invitaciones.
                    </div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            let linkAdd        =  "{{ route('invitacion-add', ['evento' => $evento->_id])  }}";
            ...
            $('#dt-files').DataTable({
                ...
                "columns":[
                    {"width": "15%", data: 'Tipo', "searchable": true, "bSortable": false},
                    {"width": "10%", data: 'SizeImagen', "searchable": true, "bSortable": false},
                    {"width": "10%", data: 'SizePdf', "searchable": true, "bSortable": false},
                    {
                        "width": "9%",
                        data: 'opciones',
                        "searchable": false,
        ...
        function modalDelete(id){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '../ajax-invitacion-delete-files',
                        data: {'id': id},
                        dataType: 'json',
                        beforeSend: function() {
                        },
